            ...
            <div className="grid-y" style={{"height": "100%", "maxHeight": "800px", "minHeight": "400px"}}>
                {
                    this.props.gameState === 'In Lobby' ?
                        <React.Fragment>
                            ...
                            <div className="cell small-6 medium-6 center-align">
                                ...
                                <div className="grid-x full-height">
                                    ...
                                    <div className="cell small-8">
                                        <div className="grid-y full-height">
                                            ...
                                            <div className="cell small-1"></div>
                                            <div className="cell small-4 medium-3 question-text">{this.props.questionNumber}. {this.props.questionText}</div>
                                            <div className={`cell small-1 question-text  answer-text ${this.props.correctAnswer === "A"? "correct-answer": ""}`}>A. {this.props.answers && this.props.answers['A']}</div>
                                            <div className={`cell small-1 question-text  answer-text ${this.props.correctAnswer === "B"? "correct-answer": ""}`}>B. {this.props.answers && this.props.answers['B']}</div>
                                            <div className={`cell small-1 question-text  answer-text ${this.props.correctAnswer === "C"? "correct-answer": ""}`}>C. {this.props.answers && this.props.answers['C']}</div>
                                            <div className={`cell small-1 question-text  answer-text ${this.props.correctAnswer === "D"? "correct-answer": ""}`}>D. {this.props.answers && this.props.answers['D']}</div>
                                        </div>
                                    </div>
                                    <div className="cell small-2"></div>
                                </div>
                                ...
                                <div className="grid-x full-height">
                                    ...
                                    <div className="cell small-8">
                                        <div className="grid-y full-height">
                                            ...
                                            <div className="cell small-1"></div>
                                            <div className="cell small-4 medium-3 question-text">{this.props.questionNumber}. {this.props.questionText}</div>
                                            <div className="cell small-1 question-text answer-text" onClick={() => this.props.submitAnswer("A")}>A. {this.props.answers && this.props.answers['A']}</div>
                                            <div className="cell small-1 question-text answer-text" onClick={() => this.props.submitAnswer("B")}>B. {this.props.answers && this.props.answers['B']}</div>
                                            <div className="cell small-1 question-text answer-text" onClick={() => this.props.submitAnswer("C")}>C. {this.props.answers && this.props.answers['C']}</div>
                                            <div className="cell small-1 question-text answer-text" onClick={() => this.props.submitAnswer("D")}>D. {this.props.answers && this.props.answers['D']}</div>
                                        </div>
                                    </div>
                                    <div className="cell small-2"></div>
                                </div>
